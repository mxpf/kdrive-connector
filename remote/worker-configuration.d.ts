/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4ce1ad1739d6bbeec23f4b342f0e82a1)
// Runtime types generated with workerd@1.20260918.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	ALLOWED_GITHUB_LOGIN: "mxpf";
	KDRIVE_CONNECTOR_BASE_URL: "https://kdrive-connector-mcp.maxpfennighaus.workers.dev";
	KDRIVE_MAX_READ_BYTES: "2097152";
	KDRIVE_MAX_UPLOAD_BYTES: "10485760";
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").KDriveMCP>;
	KDRIVE_OPERATION_NONCES: DurableObjectNamespace<import("./src/index").KDriveOperationNonceStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "KDriveMCP" | "KDriveOperationNonceStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_GITHUB_LOGIN" | "KDRIVE_CONNECTOR_BASE_URL" | "KDRIVE_MAX_READ_BYTES" | "KDRIVE_MAX_UPLOAD_BYTES">> {}
}
